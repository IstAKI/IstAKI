...
<p>Для приклодного ПО</p>
  <a>+ Rider (Использую только из-за удобной настройки и приятных тем)</a>
  <a>+ Visual Studio 2022 (Использовал только для создания Windows Form и WFP приложений)</a>
<p> </p>
<p>Для Web-сайтов</p>
  + WebStorm (Отличная IDE с предпросмотром)
